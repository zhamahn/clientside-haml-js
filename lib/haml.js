...
(function() {
    ...
    generateElementAttributes: function(context, id, classes, objRefFn, attrList, attrFunction, lineNumber, characterNumber, currentLine, handleError) {
      ...
      if (attributes) {
        for (attr in attributes) {
          ...
          } else if (attributes[attr] === void 0) {
            html += ' ' + attr;
          }
        }
      }
  ...
  Tokeniser = (function() {
    ...
    Tokeniser.prototype.tokenMatchers = {
      ...
      identifier: new RegExp(['([\\*#@]?[a-zA-Z][a-zA-Z0-9\\-\\.]*)', '(\\[\\(?[\\*]?[a-zA-Z][a-zA-Z0-9\\-\\.]*\\)?\\])', '(\\([\\*]?[a-zA-Z][a-zA-Z0-9\\-\\.]*\\))'].join('|'), 'g'),
      quotedString: /[\'][^\'\n]*[\']/g,
      quotedString2: /[\"][^\"\n]*[\"]/g,
      comment: /\-#/g,
      escapeHtml: /\&=/g,
    ...
    Tokeniser.prototype.getNextToken = function() {
      var ch, ch1, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, startOfLine, str, tokenString;
      ...
      if (this.buffer === null || this.buffer.length === this.bufferIndex) {
        ...
        this.initLine();
        startOfLine = this.characterNumber === 0;
        if (!this.token) {
        ...
        if (((ref = this.prevToken) != null ? ref.idSelector : void 0) || ((ref1 = this.prevToken) != null ? ref1.classSelector : void 0) || ((ref2 = this.prevToken) != null ? ref2.ws : void 0) || this.prevToken === null || ((ref3 = this.prevToken) != null ? ref3.eol : void 0)) {
        ...
        if (((ref4 = this.prevToken) != null ? ref4.element : void 0) || ((ref5 = this.prevToken) != null ? ref5.classSelector : void 0) || this.prevToken === null || ((ref6 = this.prevToken) != null ? ref6.indent : void 0) || ((ref7 = this.prevToken) != null ? ref7.eol : void 0)) {
        ...
        if (((ref8 = this.prevToken) != null ? ref8.element : void 0) || ((ref9 = this.prevToken) != null ? ref9.idSelector : void 0) || ((ref10 = this.prevToken) != null ? ref10.ws : void 0) || ((ref11 = this.prevToken) != null ? ref11.classSelector : void 0) || this.prevToken === null || ((ref12 = this.prevToken) != null ? ref12.eol : void 0)) {
        ...
        if (((ref13 = this.prevToken) != null ? ref13.openBracket : void 0) || ((ref14 = this.prevToken) != null ? ref14.ws : void 0)) {
        ...
        if (!this.token) {
          ...
          if (!str) {
            str = this.matchToken(this.tokenMatchers.numberLiteral);
            tokenString = parseInt(str);
          }
          if (str) {
            tokenString || (tokenString = str.substring(1, str.length - 1));
            this.token = {
              string: true,
              token: 'STRING',
        ...
        if (((ref15 = this.prevToken) != null ? ref15.element : void 0) || ((ref16 = this.prevToken) != null ? ref16.idSelector : void 0) || ((ref17 = this.prevToken) != null ? ref17.classSelector : void 0)) {
  ...
  haml = {
    ...
    _isSelfClosingTag: function(tag) {
      return tag === 'meta' || tag === 'img' || tag === 'link' || tag === 'script' || tag === 'br' || tag === 'hr' || tag === 'input';
    },
